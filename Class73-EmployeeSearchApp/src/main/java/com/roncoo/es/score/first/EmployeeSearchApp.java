...
//		executeSearch(client);
	...
	private static void executeSearch(TransportClient client) {
		SearchResponse response = client.prepareSearch("company")
				.setTypes("employee")
				.setQuery(QueryBuilders.matchQuery("position", "technique"))  //positon包含technique
				.setPostFilter(QueryBuilders.rangeQuery("age").from(30).to(40))     //年龄在30~40岁之间
				.setFrom(0).setSize(1)       //分页查询：查找第一页
				.get();
